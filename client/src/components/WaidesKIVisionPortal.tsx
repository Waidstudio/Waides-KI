          ...
          <div className="h-full flex flex-col p-6">
              ...
              <div className="bg-gradient-to-r from-emerald-500/10 to-teal-600/10 border border-emerald-500/20 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {/* Quick Action Buttons inside the message */}
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
                      <button className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-blue-500/20 rounded-xl p-4 text-center hover:from-blue-500/30 hover:to-blue-600/30 transition-all">
                        <Brain className="w-6 h-6 text-blue-400 mx-auto mb-2" />
                        <div className="text-sm text-blue-300 font-medium">Generate Strategy</div>
                      </button>
                      
                      <button className="bg-gradient-to-br from-green-500/20 to-green-600/20 border border-green-500/20 rounded-xl p-4 text-center hover:from-green-500/30 hover:to-green-600/30 transition-all">
                        <Bot className="w-6 h-6 text-green-400 mx-auto mb-2" />
                        <div className="text-sm text-green-300 font-medium">Command Bots</div>
                      </button>
                      
                      <button className="bg-gradient-to-br from-purple-500/20 to-purple-600/20 border border-purple-500/20 rounded-xl p-4 text-center hover:from-purple-500/30 hover:to-purple-600/30 transition-all">
                        <Wallet className="w-6 h-6 text-purple-400 mx-auto mb-2" />
                        <div className="text-sm text-purple-300 font-medium">Fund Account</div>
                      </button>
                      
                      <button className="bg-gradient-to-br from-orange-500/20 to-orange-600/20 border border-orange-500/20 rounded-xl p-4 text-center hover:from-orange-500/30 hover:to-orange-600/30 transition-all">
                        <TrendingUp className="w-6 h-6 text-orange-400 mx-auto mb-2" />
                        <div className="text-sm text-orange-300 font-medium">Market Analysis</div>
                      </button>
                      
                      <button className="bg-gradient-to-br from-cyan-500/20 to-cyan-600/20 border border-cyan-500/20 rounded-xl p-4 text-center hover:from-cyan-500/30 hover:to-cyan-600/30 transition-all">
                        <Activity className="w-6 h-6 text-cyan-400 mx-auto mb-2" />
                        <div className="text-sm text-cyan-300 font-medium">Live Trading</div>
                      </button>
                      
                      <button className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 border border-yellow-500/20 rounded-xl p-4 text-center hover:from-yellow-500/30 hover:to-yellow-600/30 transition-all">
            ...
            <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl border border-emerald-500/20 p-6">
              <div className="flex gap-4">
                ...
                />
                <button className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-8 py-4 rounded-lg transition-all flex items-center gap-3 text-lg font-medium">
                  <Send className="w-5 h-5" />
                  Send
                </button>
              </div>
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                <button className="px-4 py-2 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-300 text-sm rounded-full border border-emerald-500/30 transition-all font-medium">
